<div class="col-9 mt-5">
    ...
    <div class="col-12 mt-2 p-3 bg-white shadow">
        <h1 class="h2 text-center mt-3 mb-5">Управление категорией (ID: <?=$seller->id?>)</h1>
        <div class="col-7 center">
            <form name="edit_seller" method="post">
                <table>
                    <tr>
                        <td>Название</td>
                        <td><input type="text" class="w_auto" name="title" value="<?=$category->title?>" /></td>
                    </tr>
                    <tr>
                        <td>Раздел</td>
                        <td><input type="text" class="w_auto" name="section_id" value="<?=$category->section_id?>" /></td>
                    </tr>
                    <tr>
                        <td colspan="2">
